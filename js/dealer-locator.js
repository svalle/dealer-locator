...
var Utility = function() {
        function e(e, t, i) {
            ...
            return function() {
                var a = this,
                    ...
                    s = i && !n;
                clearTimeout(n), n = setTimeout(r, t), s && e.apply(a, o)
            }
        }
        ...
        function n() {
            if (k && console && "function" == typeof console.log)
                for (var e = 0, t = arguments.length; t > e; e++) console.log(arguments[e])
        }

        function a() {
            if (k && console && "function" == typeof console.debug)
                for (var e = 0, t = arguments.length; t > e; e++) console.debug(arguments[e])
        }

        function o() {
            if (k && console && "function" == typeof console.warn)
                for (var e = 0, t = arguments.length; t > e; e++) console.warn(arguments[e])
        }

        function r() {
            if (k && console && "function" == typeof console.error)
                for (var e = 0, t = arguments.length; t > e; e++) console.error(arguments[e])
        }
        ...
        function s(e, t, i, n) {
            if (null != t) {
                ...
                if (o.innerHTML = e, null != i && (o.className = i), n)
                    for (var r in n) o.setAttribute(r, n[r]);
                return a.appendChild(o), a
            }
            Utility.error("Utility.createHTML() requires that you send it a root element (rootElement) to insert the html string (htmlStr) into.")
        }

        function l() {
            for (var e = document.getElementsByTagName("script"), t = e[e.length - 1], i = 0; i < arguments.length; i++) {
                var n = new XMLHttpRequest;
                n.onload = function() {
                    if ("404" !== this.status.toString()) {
                        var e = document.createElement("div");
                        e.innerHTML = this.responseText, e.style.display = "none", t.parentNode.insertBefore(e, t)
                    }
                }, n.onerror = function(e) {
                    Utility.error("Utility.svgLoader() Error:" + e.message)
                }, n.open("get", arguments[i], !0), n.send()
            }
        }
        ...
        function h(e, t) {
            return null != t && t.className ? new RegExp("(\\s|^)" + e + "(\\s|$)").test(t.className) : !1
        }

        function u(e, t) {
            var n, a = document.querySelectorAll("." + t);
            for (i = 0; i < a.length; i++)
                if (n = a[i], n.classList) n.classList.toggle(e);
                else {
                    var o = n.className.split(" "),
                        r = o.indexOf(e);
                    r >= 0 ? o.splice(r, 1) : o.push(e), n.className = o.join(" ")
                }
        }
        ...
        function y() {
            var e = !1;
            return window.innerWidth < 550 ? e = !0 : screen.width < window.innerWidth && screen.width < 550 && (e = !0), e
        }

        function b() {
            var e = !1;
            return Utility.isMobile() || (window.innerWidth >= 550 && window.innerWidth < 1024 ? e = !0 : screen.width < window.innerWidth && screen.width >= 550 && screen.width <= 1024 && (e = !0)), e
        }

        function C() {
            var e = !Utility.isMobile() && !Utility.isTablet();
            return e
        }
        var w = window.location.hostname,
            k = w.match(/localhost|127.0.0.1|192.168.1.242|10.13.126.197|10.13.132.140|autos.hotfixes.dev.ignition.razorfish.com|automobiles.dev.ignition.razorfish.com|autos.dev.ignition.razorfish.com/);
        return {
            debounce: e,
            log: n,
            logBlue: a,
...
Utility.log('DealerLocator.js loaded');
  ...
  function init() {
    try {
      ...
      if($form.length > 0){Utility.error(e);}
    }
  }
  ...
  function addPins(dealers) {
    ...
    for(var i = 0; i < dealers.length; i++) {
      pins[i] = {'lat': dealers[i].Latitude, 'lng': dealers[i].Longitude};
    }
